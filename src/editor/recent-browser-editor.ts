  ...
  protected render(): TemplateResult {
    ...
    return html`
      <div class="schema-title">
        Settings that control the <a href="https://github.com/thlucas1/homeassistantcomponent_soundtouchplus_card/wiki/Configuration-Options#recently-played-section-options" target="_blank">
        Recently Played Section</a>look and feel
      </div>
